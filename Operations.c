...
{
    printf("\nWelcome %s. You will be playing against the Computer today.", strupr(Iname));
        ...
        if (mLwrReady == 'y')
        {
            ...
            { 
                ...
                if(mPTurnToPlay)
                {
                    ...
                    case '1':
                        ...
                        else
                        {
                            ...
                            RegisterPlayedCell(mCurPlay, first, mPTurnToPlay, mCTurnToPlay);

                            //Display Result if there is a match
                            Result(mPTurnToPlay, mCTurnToPlay, mName);
                        }                     
                        break;
                    ...
                    case '2':
                        ...
                        else
                        {
                            ...
                            RegisterPlayedCell(mCurPlay, second, mPTurnToPlay, mCTurnToPlay);
                    ...
                    case '3':
                        ...
                        else
                        {
                            ...
                            RegisterPlayedCell(mCurPlay, third, mPTurnToPlay, mCTurnToPlay);
                    ...
                    case '4':
                        ...
                        else
                        {
                            ...
                            RegisterPlayedCell(mCurPlay, fourth, mPTurnToPlay, mCTurnToPlay);
                    ...
                    case '5':
                        ...
                        else
                        {
                            ...
                            RegisterPlayedCell(mCurPlay, fifth, mPTurnToPlay, mCTurnToPlay);
                    ...
                    case '6':
                        ...
                        else
                        {
                            ...
                            RegisterPlayedCell(mCurPlay, sixth, mPTurnToPlay, mCTurnToPlay);
                    ...
                    case '7':
                        ...
                        else
                        {
                            ...
                            RegisterPlayedCell(mCurPlay, seventh, mPTurnToPlay, mCTurnToPlay);
                    ...
                    case '8':
                        ...
                        else
                        {
                            ...
                            RegisterPlayedCell(mCurPlay, eight, mPTurnToPlay, mCTurnToPlay);
                    ...
                    case '9':
                        ...
                        else
                        {
                            ...
                            RegisterPlayedCell(mCurPlay, ninth, mPTurnToPlay, mCTurnToPlay);
                ...
                else if(mCTurnToPlay = true)
                {
                    ...
                    RegisterPlayedCell(mCurPlay, 0, mPTurnToPlay, mCTurnToPlay);
